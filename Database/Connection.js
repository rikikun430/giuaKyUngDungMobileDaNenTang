...
const createTodosTable = () => {
  return new Promise((resolve, reject) => {
    db.transaction((tx) => {
      tx.executeSql(
        "CREATE TABLE IF NOT EXISTS ToDos (id INTEGER PRIMARY KEY AUTOINCREMENT, taskId INTEGER, title TEXT, StartTime TEXT, EndTime TEXT,color TEXT , completed INTEGER)",
        [],
        (_, result) => {
